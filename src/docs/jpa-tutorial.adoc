...
Per poter operare sulle serializzazione e deserializzazione delle entity si utilizza l'oggetto *EntityManager*
In modo dipendente dal framework in uso l'entityManager può essere:

* Injected dal framework in automatico
