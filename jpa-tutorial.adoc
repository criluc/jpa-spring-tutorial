...
- Se necessario è possibile utilizzare chiavi primarie composte – ma di solito
  non è preferibile farlo. Meglio evitare di rendere meno chiaro il codice.

- Si può indicare una strategia per la generazione automatica dei valori delle
chiavi primarie con:
[source,java]
----
include::src/main/java/it/besmartbeopen/model/BlogEntry.java[lines=15..17]
----
